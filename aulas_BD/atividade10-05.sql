...
--O GERENTE QUER UMA LISTA APENAS DOS JOGOS QUE GUSTAM MAIS DE 200,00
select * from jogo
...
--MOSTRE APENAS OS JOGOS DE 'AÇÃO', MAS ORDENADO DO MAIS VENDIDO PARA O MENOR VENDIDO 
select * from jogo 
where ds_categoria = 'Ação'
ORDER by  nm_jogo DESC

--EXIBA TODOS OS JOGOS DE TERROR EM ORDEM ALFABETICA INVERSA!
select * from jogo 
